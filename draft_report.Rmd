...
```{r}
plot_onegeno_test(bxd_results[['ph_geno']], bxd_results[['ph_geno_haploqa']], bxd_results[['map']], ind = 5, 
                          shift = TRUE, main = paste0('qtl2 - Geno-wide genotypes of individual ', 50),
                          sub = 'Left - qtl2, Right - HaploQA') 
```
...
```{r}
f2_results <- haplotype_reconstruction_pipeline('F2', list_pheno, qtl2_file_gen = T, samples_gen = T)
```
...
```{r}
plot_onegeno_test(f2_results[['ph_geno']], f2_results[['ph_geno_haploqa']], f2_results[['map']], ind = 5, 
                          shift = TRUE, main = paste0('qtl2 - Geno-wide genotypes of individual ', 50),
                          sub = 'Left - qtl2, Right - HaploQA') 
```
