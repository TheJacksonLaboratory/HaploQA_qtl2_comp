...
(add screenshots of karyotype plots for outliers)
...
(make a plot to visualize run time)
(talk about the strengths and weaknesses)
(figure out the error LOD)
qtl2 does not scale well with large number of founders
...
qtl2fst - store large objects 
calc_genoprob_fst
(allele prob fst)
for DO - 
time the regular genoprob and fst
get the file size/memory usage of RDS and FST
