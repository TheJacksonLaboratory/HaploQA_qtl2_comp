...
(some backgrounds about when the optimal models were built/what about them makes them optimal?) Some optimal models were built for each of the crosses in qtl2, which 
...
df_qtl2_truth_diff <- as.data.frame(cbind('do_qtl2_truth_diff' = do_qtl2_truth_diff, 'cc_qtl2_truth_diff' = cc_qtl2_truth_diff, 'bxd_qtl2_truth_diff' = bxd_qtl2_truth_diff, 'f2_qtl2_truth_diff' = f2_qtl2_truth_diff))
df_qtl2_truth_diff
```
